...
CC.ZTSM[78] = {"杀破狼计时","【杀破狼】特效的计时。",1,"CD:","回合","杀破狼CD"}
...
CC.ZTSM[103] = {"冻结","冻结者不能攻击/移动/用指令（和昏迷、恐惧、定乾坤同类），集气时序不增长，冻结目标不计算闪避，被攻击必中，每时序掉 0.5% 血。",2,"CD:","回合","冻结"}
CC.ZTSM[104] = {"天霜劲","攻击有冰封状态的敌人伤害+20%，天霜劲+虚云劲+神风劲之和大于10层，受到致命伤害则消耗所有三元状态回复自身状态50%，并且当前回合免疫伤害。",1,"CD:","回合","天霜劲"} 
CC.ZTSM[105] = {"玄冰界","CD300时序，受到致命伤害时，免疫本次伤害并冻结自己30时序（270<=玄冰界<= 300），冰冻其间免疫一切伤害并时序回复1%最大生命值。",1,"CD:","回合","玄冰界"}
...
CC.ZTSM[113] = {"天子观气","敌方全体集气减半,命中减少20%。。",2,"CD:","回合","天子"}
...
CC.ZTSM[118] = {"六道轮回","进入战斗开始降低N%附加三围,每回合增加N%附加三围，每六个回合一轮回，轮回结束时恢复一定百分比的生命/内力/体力，清除所有异常状态。",1,"CD:","回合","六道"}
...
CC.ZTSM[123] = {"权谋","持续最少三回合，三回合后如血量超过50%，则结束权谋状态,“权谋”状态内免疫硬控效果，且接下来3个回合内，每次造成伤害时都会额外吸取伤害量30%的生命值。同时，敌方每有1名角色在“权谋”状态期间阵亡，提升5%攻击力（上限20%）,持续整场战斗。",1,"CD:","回合","权谋"}
...
CC.ZTSM[143] = {"万蛊","已经触发【万蛊引瘴】的次数。",1,"CD:","回合","九歌"}
CC.ZTSM[144] = {"火蝶盅CD","火蝶盅CD。",1,"CD:","回合","火蝶"}
CC.ZTSM[145] = {"血魔母盅","血魔子盅会分担母盅受到的伤害。",1,"CD:","回合","母盅"}
CC.ZTSM[146] = {"禁疗","不能被动回复生命、内力、体力。",1,"CD:","回合","禁疗"}
CC.ZTSM[147] = {"剑气逆乾坤","使用剑法攻击免疫反击和反伤，附加伤害20%吸血（上限100×外功层级），追加1000气攻；五岳神剑攻击必破气防；受到攻击时减少(御剑系数÷2)的真伤（上限300）；持续整场战斗，切换其余内功会暂时失效。",1,"CD:","回合","剑气"}
`;